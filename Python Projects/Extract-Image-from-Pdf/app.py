...
def open_file():
    ...
    if file:
        ...
        #arrow buttons
        display_icon('images/arrow_l.png', 2, 0, E, lambda:left_arrow(all_images, selected_image, what_text))
        display_icon('images/arrow_r.png', 2, 2, W, lambda:right_arrow(all_images, selected_image, what_text))
...
display_logo('images/logo.png', 0, 0)
